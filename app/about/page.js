...
import { getCabins } from "../_lib/data-servers";
    ...
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="relative aspect-square col-span-2">
        <Image
          ...
          alt="Family that manages The Cabins Hotel"
        />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Cabins Hotel has been a cherished family-run
          ...
          <p>
            ...
            Hotel, blending the timeless beauty of the mountains with the
            personal touch only a family business can offer. Here, you&apos;re
            not just a guest; you&apos;re part of our extended family. So join
            us at The Cabins Hotel soon, where tradition meets tranquility, and
